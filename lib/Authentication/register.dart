...
class _RegisterState extends State<Register> {
    ...
    if (_imageFile == null) {
      showDialog(
          ...
          builder: (c) {
            return ErrorAlertDialog(
              message: "SVP selectionnez une image",
            );
          });
    } else {
      _passwordTextEditingController.text ==
          ...
          ? _emailTextEditingController.text.isNotEmpty &&
              ...
              ? uploadToStorage()
              : displayDialog("SVP Remplissez le Form ..")
          : displayDialog("Le Mot de Passe ne correspond pas.");
    }
  }
  ...
  void _registerUser() async {
    ...
    if (firebaseUser != null) {
      saveUserInfoToFirebaseStore(firebaseUser).then((value) {
        Navigator.pop(context);
  ...
  Future saveUserInfoToFirebaseStore(FirebaseUser fUser) async {
