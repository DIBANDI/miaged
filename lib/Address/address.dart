...
import 'package:miage_shop/Orders/placeOrderPayment.dart';
import 'package:miage_shop/Widgets/customAppBar.dart';
import 'package:miage_shop/Widgets/loadingWidget.dart';
import 'package:miage_shop/Widgets/wideButton.dart';
import 'package:miage_shop/Counters/changeAddresss.dart';
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text("Aucune adresse d'expedition enregistrée"),
            Text("SVP enregistrez votre adresse d'expedition"),
          ],
        ),
      ),
    );
